...
export interface Preferences { project?: string; theme?: 'system' | 'light' | 'dark'; split?: number; syncScroll?: boolean; fontSize?: number; library?: { category:string; query:string; year:string; month:string; tags:string[]; sort:string; selected?:string; scroll:number } }
